...
public class MaterieData {
    ...
    public void init(){
        ...
        cursuri =  Arrays.asList(cursData.getCursuri().get(7),cursData.getCursuri().get(8),cursData.getCursuri().get(9));
        ...
        cursuri =  Arrays.asList(cursData.getCursuri().get(10),cursData.getCursuri().get(11),cursData.getCursuri().get(12));
        materii.add(new Materie(3, "Istorie","Frumoasa materia\nCerinte minime de intrare in examen: 50pct\nBonusuri: 12pct\nOrar: MIERCURI 11:00-16:00",cursuri));
        cursuri =  Arrays.asList(cursData.getCursuri().get(13),cursData.getCursuri().get(14),cursData.getCursuri().get(15));
        materii.add(new Materie(4, "Mate1","Frumoasa materia\nCerinte minime de intrare in examen: 20pct\nBonusuri: n-avem\nOrar: VINERI 18:00-20:00",cursuri));
        cursuri =  Arrays.asList(cursData.getCursuri().get(16),cursData.getCursuri().get(17),cursData.getCursuri().get(18));
        materii.add(new Materie(5, "Mate2","Frumoasa materia\nCerinte minime de intrare in examen: 60pct\nBonusuri: n-avem\nOrar: LUNI 09:00-12:00",cursuri));
        cursuri =  Arrays.asList(cursData.getCursuri().get(19),cursData.getCursuri().get(20),cursData.getCursuri().get(21));
        ...
        cursuri =  Arrays.asList(cursData.getCursuri().get(22),cursData.getCursuri().get(23),cursData.getCursuri().get(24));
        materii.add(new Materie(7, "Fizica","Frumoasa materia\nCerinte minime de intrare in examen: 50pct\nBonusuri: n-avem\nOrar: MARTI 08:00-10:00",cursuri));
        cursuri =  Arrays.asList(cursData.getCursuri().get(25),cursData.getCursuri().get(26),cursData.getCursuri().get(27));
        materii.add(new Materie(8, "Fizica2","Frumoasa materia\nCerinte minime de intrare in examen: 20pct\nBonusuri: n-avem\nOrar: LUNI 16:00-18:00",cursuri));
        cursuri =  Arrays.asList(cursData.getCursuri().get(28),cursData.getCursuri().get(29),cursData.getCursuri().get(30));
        ...
        cursuri =  Arrays.asList(cursData.getCursuri().get(31),cursData.getCursuri().get(32),cursData.getCursuri().get(33));
        materii.add(new Materie(10, "Electromagnetica","Frumoasa materia\nCerinte minime de intrare in examen: 20pct\nBonusuri: n-avem\nOrar: VINERI 08:00-11:00",cursuri));
        cursuri =  Arrays.asList(cursData.getCursuri().get(34),cursData.getCursuri().get(35),cursData.getCursuri().get(36));
